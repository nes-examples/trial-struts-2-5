...
dependencies {
    ...
    implementation("org.apache.struts:struts2-sitemesh-plugin:2.5.33-struts2-2.5.35-trial")
    implementation("org.apache.struts:struts2-tiles-plugin:2.5.33-struts2-2.5.35-trial")
    implementation("org.apache.struts:struts2-dwr-plugin:2.5.33-struts2-2.5.35-trial")
    implementation("org.apache.struts:struts2-json-plugin:2.5.33-struts2-2.5.35-trial")
    implementation("org.apache.tiles:tiles-jsp:3.0.8")
    implementation("org.apache.struts:struts2-convention-plugin:2.5.33-struts2-2.5.35-trial")
    implementation("org.apache.struts:struts2-spring-plugin:2.5.33-struts2-2.5.35-trial")
    implementation("org.apache.struts:struts2-bean-validation-plugin:2.5.33-struts2-2.5.35-trial")
